...
public:
    ...
    cost FindCornerLocPath(xyLoc from, xyLoc to, std::vector<CornerLoc> &thePath);
...
private:
    ...
    struct State {
        ...
        State(CornerLoc _l, Interval _interval) :
    ...
    const ANYAStateKey GenerateKey(const CornerLoc l, const Interval I) const;
    ...
    const stateId GenerateState(const CornerLoc l, const Interval I, const CornerLoc goal);
    ...
    void GenerateSubIntervals(const int row, const double left, const double right, const CornerLoc root, const CornerLoc goal, std::vector<stateId> & ids);
    ...
    void GenerateIntervalsTowardsLeft(const double fx, const int y, const int unblocked_dir, const CornerLoc root, const CornerLoc goal,
            std::vector<stateId> & successors, const double bound = 0);
    void GenerateIntervalsTowardsRight(const double fx, const int y, const int unblocked_dir, const CornerLoc root, const CornerLoc goal,
    ...
    // 'successors' vector.
    void GenerateSuccessors_SameRow(const CornerLoc root, const Interval interval, const CornerLoc goal, std::vector<stateId> & successors);
    void GenerateSuccessors_DifferentRow(const CornerLoc root, const Interval interval, const CornerLoc goal, std::vector<stateId> & successors);
    void GenerateSuccessors(const CornerLoc root, const Interval interval, const CornerLoc goal, std::vector<stateId> & successors);
    ...
    void InitializeSearch(const CornerLoc from, const CornerLoc to);
    ...
    cost HeuristicDistance(const CornerLoc root, const Interval interval, const CornerLoc goal) const;
    ...
    void ProcessDebugLoc(CornerLoc l);
#endif
